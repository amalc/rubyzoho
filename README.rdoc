...
== Use
RubyZoho attenmpts to follow the ActiveRecord lifecycle, i.e. new, save and delete
at this point.
...
To create a new record:
    ...
    c.save
    c = RubyZoho::Crm::Lead.find_by_email('email@domain.com')
    c.contactid # => Has the newly created contact's ID
...
Please open an issue on GitHub. Or better, send in a pull request.

---

== Contributing to rubyzoho

* Pull requests with specs and a version branch are welcomed.
