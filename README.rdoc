...
2. Only 'text' custom fields appear to be getting updated. Proved that 'currency' type fields do not get updated.

=== Roadmap (Ranked)
1. Add related records using AR style syntax, e.g.
    pp a.contacts
