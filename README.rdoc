...
Set <tt>config.cache_fields = true</tt> in the configuration block to cache fields lists
during development and testing and reduce total API calls during start up. Defaults to false. We <b>do not</b> recommend use of this
in production.
