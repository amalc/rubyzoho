Travis CI {<img src="https://travis-ci.org/amalc/rubyzoho.png?branch=master" alt="Build Status" />}[https://travis-ci.org/amalc/rubyzoho]
...
Copyright (c) 2013 amalc. See LICENSE.txt for
further details.
