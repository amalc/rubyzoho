...
ActiveRecord lifecycle, but without ActiveRecord. Current focus is on Zoho CRM. Release notes are
...
[0.1.7] RC 1 (In Development)
        ...
        * ActiveRcord style syntax for Class.new, Class.delete, Class.update, Object.save
        * << syntax for Account/Tasks on Master/Detail relationships

[0.1.1 - 6] Alpha Releases. Configuration signature changed.
[0.0.1 - 5] Alpha Releases
