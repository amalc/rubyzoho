...
or where the Zoho API sends back an explicit error code which isn't in the set

    ['4422', '5000']

a RuntimeError exception is raised with the Zoho API message.
