...
Set <tt>config.cache_fields = true</tt> in the configuration block to cache module field lists
during development and testing to reduce total API calls during start up. Defaults to false.
We <b>do not</b> recommend use of this in production.
