...
2. Only text fields can be updated as custom fields. At this point it isn't clear what to send thw Zoho API to have it accept anything else. Please send in a PR if you figure it out.
