...
Put the following in an initializer (e.g. zoho.rb):
    ...
    RubyZoho.configure do |config|
      ...
      config.crm_modules = ['Accounts', 'Contacts', 'Leads', 'Potentials', 'Quotes'] # Depending on what kind of account you've got
      # config.crm_modules = ['Accounts', 'Contacts', 'Leads', 'Potentials'] # Free edition
    end
